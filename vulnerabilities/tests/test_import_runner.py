...
def test__get_or_create_vulnerability(db):

    adv1 = Advisory(
        summary="foobar", impacted_package_urls=[], resolved_package_urls=[], cve_id="12"
    )
    adv2 = Advisory(
        summary="foobar", impacted_package_urls=[], resolved_package_urls=[], cve_id="13"
    )
    adv3 = Advisory(summary="foobar", impacted_package_urls=[], resolved_package_urls=[], cve_id="")

    _get_or_create_vulnerability(adv1)
    _get_or_create_vulnerability(adv2)
    _get_or_create_vulnerability(adv3)
